...
const ToDoList: React.FC = () => {
  const [tasks, setTasks] = useState<Task[]>([{ id: 1, text: 'Create Guest Experience mobile check-in', completed: false },
  ...
  return (
     <div className="w-full h-full min-h-screen bg-gray-800 text-white flex items-center justify-center">
      ...
      <div className="flex flex-col">
        <label htmlFor="new-task" className="mb-2 text-lg">Add todo</label>
        <input
          type="text"
          value={newTask}
